...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      'Аналитика — Firebase Analytics арқылы жиынтық статистика (анонимді).',
  ...
  },
  {
    ...
    content: [
      ...
      'Біз міндетті (аутентификация, қауіпсіздік) және аналитикалық (Firebase Analytics) cookie-лерді қолданамыз.',
      'Сіз браузер баптауларында cookie-лерді өшіре аласыз, бірақ бұл сайттың кейбір функцияларының жұмысын бұзуы мүмкін.',
    ],
  },
  {
    id: 'firebase',
    title: '5. Firebase қызметтері',
    content: [
      'Платформа Firebase Realtime Database және Firebase Analytics қызметтерін пайдаланады.',
      'Firebase деректерді Google серверлерінде сақтайды. Google-дың Құпиялық саясатына қолданылады: policies.google.com/privacy.',
      'Real-time статистика (көрулер, эпизод ойнатулар) анонимді түрде сақталады.',
    ],
  },
  {
    id: 'sharing',
    ...
    content: [
      ...
      'Сервис провайдерлері (Firebase, хостинг) тек техникалық қажеттілік үшін қол жеткізеді.',
    ],
  },
  {
    id: 'storage',
    ...
    content: [
      ...
      'Көрулер статистикасы — Firebase RTDB-де жинақталған күйде сақталады.',
    ],
  },
  {
    id: 'rights',
